...
a.Windows11，安装HIP 6.4.2 https://www.amd.com/en/developer/resources/rocm-hub/hip-sdk.html
    其他如果不支持HIP 6.4.2的老显卡，可能需要参考https://github.com/CS1o/Stable-Diffusion-Info/wiki/Lora-Trainer-Setup-Guides#amd-onetrainer-with-zluda
...
2.cd OneTrainer && py scripts/install_zluda.py（确保脚本顺利完成，没有报错。如果报错请确保网络稳定正常）
